...
export default function Header() {
  ...
  const resources = [
    ...
    { href: '/money-guide/', label: locale === 'es' ? 'Dinero y Propinas' : 'Money & Tipping' },
    { href: '/activities/', label: locale === 'es' ? 'Actividades Familiares' : 'Family Activities' },
    ...
    { href: '/culture/', label: locale === 'es' ? 'Cultura y Costumbres' : 'Culture & Customs' },
    { href: '/shopping/', label: locale === 'es' ? 'Souvenirs y Compras' : 'Shopping Guide' },
