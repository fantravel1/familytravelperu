...
export const sites: Site[] = [
  {
    ...
    youtubeVideoId: 'cnMa-Sm9H4k',
    youtubeVideoTitle: 'Machu Picchu 101 | National Geographic',
  ...
  },
  {
    ...
    youtubeVideoId: '6JDKr7qqHkE',
    youtubeVideoTitle: 'Sacsayhuaman: The Ancient Inca Fortress Above Cusco',
  ...
  },
  {
    ...
    imageCredit: 'Diego Delso, Wikimedia Commons (CC BY-SA 4.0)',
    youtubeVideoId: 'rKPK3pCmqHE',
    youtubeVideoTitle: 'Ollantaytambo: The Living Inca Town',
  ...
  },
  {
    ...
    youtubeVideoId: 'gV-1fxLZ3YM',
    youtubeVideoTitle: 'Pisac Ruins & Market: Sacred Valley Peru',
    quechuaName: 'P\'isaq',
  ...
  },
  {
    ...
    youtubeVideoId: 'rSiJyO9Q-3E',
    youtubeVideoTitle: 'Moray: The Inca Agricultural Laboratory',
    quechuaName: 'Muray',
  ...
  },
  {
    ...
    regionEs: 'Región Cusco',
    altitude: 3380,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Salineras_de_Maras%2C_Per%C3%BA%2C_2015-07-30%2C_DD_10.JPG/1280px-Salineras_de_Maras%2C_Per%C3%BA%2C_2015-07-30%2C_DD_10.JPG',
    imageCredit: 'Diego Delso, Wikimedia Commons (CC BY-SA 4.0)',
  ...
  },
  {
    ...
    imageCredit: 'McKay Savage, Wikimedia Commons (CC BY 2.0)',
    youtubeVideoId: 'YqT93b_DVOA',
    youtubeVideoTitle: 'Rainbow Mountain Peru: Complete Guide to Vinicunca',
  ...
  },
  {
    ...
    altitude: 3400,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/203_-_Canyon_de_Colca_-_Condor_des_Andes_-_Juin_2010.JPG/1280px-203_-_Canyon_de_Colca_-_Condor_des_Andes_-_Juin_2010.JPG',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
    youtubeVideoId: 'cUFuObJcFi8',
    youtubeVideoTitle: 'Colca Canyon Peru: Condors and Ancient Terraces',
  ...
  },
  {
    ...
    imageCredit: 'Diego Delso, Wikimedia Commons (CC BY-SA 4.0)',
    youtubeVideoId: 'hD2FWOSW6Zo',
    youtubeVideoTitle: 'Lake Titicaca: The Highest Navigable Lake in the World',
  ...
  },
  {
    ...
    altitude: 20,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ab/Chan_Chan_Peru.jpg/1280px-Chan_Chan_Peru.jpg',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
    youtubeVideoId: 'JgZgZPe_n_Y',
    youtubeVideoTitle: 'Chan Chan: The Largest Adobe City in the World',
  ...
  },
  {
    ...
    regionEs: 'Región Ica',
    altitude: 500,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/L%C3%ADneas_de_Nazca%2C_Nazca%2C_Per%C3%BA%2C_2015-07-29%2C_DD_49.JPG/1280px-L%C3%ADneas_de_Nazca%2C_Nazca%2C_Per%C3%BA%2C_2015-07-29%2C_DD_49.JPG',
    imageCredit: 'Diego Delso, Wikimedia Commons (CC BY-SA 4.0)',
    youtubeVideoId: 'Z3lOrLftbpU',
    youtubeVideoTitle: 'Nazca Lines: Ancient Mysteries from the Air',
  ...
  },
  {
    ...
    type: 'archaeological',
    city: 'chachapoyas',
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Kuelap_-_panoramio.jpg/1280px-Kuelap_-_panoramio.jpg',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
    youtubeVideoId: 'kl5T5YKkqWo',
    youtubeVideoTitle: 'Kuelap: The Lost Fortress of the Cloud Warriors',
  ...
  },
  {
    ...
    altitude: 50,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/40/Huaca_Rajada.jpg/1280px-Huaca_Rajada.jpg',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
  ...
  },
  {
    ...
    regionEs: 'Región Puno',
    altitude: 3950,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Taquile_Island.jpg/1280px-Taquile_Island.jpg',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
  ...
  },
  {
    ...
    regionEs: 'Región Cusco',
    altitude: 2720,
    quechuaName: 'Wayna Pikchu',
    quechuaMeaning: 'Young Mountain',
    quechuaMeaningEs: 'Montaña Joven',
  ...
  },
  {
    ...
    regionEs: 'Región Cusco',
    altitude: 2720,
    quechuaName: 'Inti Punku',
    quechuaMeaning: 'Gate of the Sun',
    quechuaMeaningEs: 'Puerta del Sol',
  ...
  },
  {
    ...
    regionEs: 'Región Cusco',
    altitude: 3765,
    quechuaName: 'Tampumach\'ay',
    quechuaMeaning: 'Rest Cave / Lodging Cave',
    quechuaMeaningEs: 'Cueva de Descanso / Alojamiento',
  ...
  },
  {
    ...
    altitude: 3680,
    quechuaName: 'Q\'inqu',
    quechuaMeaning: 'Zigzag / Labyrinth',
    quechuaMeaningEs: 'Zigzag / Laberinto',
  ...
  },
  {
    ...
    altitude: 350,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/Caral-Peru-panoramio.jpg/1280px-Caral-Peru-panoramio.jpg',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
  ...
  },
  {
    ...
    regionEs: 'Región Cusco',
    altitude: 3050,
    quechuaName: 'Chuqi K\'iraw',
    quechuaMeaning: 'Cradle of Gold',
    quechuaMeaningEs: 'Cuna de Oro',
  ...
  },
  {
    ...
    regionEs: 'Región Cusco',
    altitude: 3762,
    quechuaName: 'Chinchiru',
    quechuaMeaning: 'Place of the Rainbow',
    quechuaMeaningEs: 'Lugar del Arcoíris',
  ...
  },
  {
    ...
    regionEs: 'Región Cusco',
    quechuaName: 'Raqchi',
    quechuaMeaning: 'Clay Pot / Ceramic',
    quechuaMeaningEs: 'Olla de Barro / Cerámica',
  ...
  },
  {
    ...
    region: 'Cusco Region',
    regionEs: 'Región Cusco',
    quechuaName: 'Piki Llaqta',
    quechuaMeaning: 'Flea Town',
    quechuaMeaningEs: 'Pueblo de las Pulgas',
  ...
  },
  {
    ...
    regionEs: 'Región Ica',
    altitude: 406,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Huacachina%2C_Peru.jpg/1280px-Huacachina%2C_Peru.jpg',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
  ...
  },
  {
    ...
    altitude: 3560,
    quechuaName: 'Tipun',
    quechuaMeaning: 'Place of Boiling Water',
    quechuaMeaningEs: 'Lugar del Agua Hirviente',
  ...
  },
  {
    ...
    regionEs: 'Región Cusco',
    altitude: 3750,
    quechuaName: 'Puka Pukara',
    quechuaMeaning: 'Red Fortress',
    quechuaMeaningEs: 'Fortaleza Roja',
  ...
  },
  {
    ...
    regionEs: 'Región Cusco',
    altitude: 4300,
    quechuaName: 'Waqra Pukara',
    quechuaMeaning: 'Horn Fortress',
    quechuaMeaningEs: 'Fortaleza de los Cuernos',
  ...
  },
  {
    ...
    regionEs: 'Región Ica',
    altitude: 0,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Paracas_National_Reserve.jpg/1280px-Paracas_National_Reserve.jpg',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
  ...
  },
  {
    ...
    regionEs: 'Región Arequipa',
    altitude: 2335,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b0/Bas%C3%ADlica_Catedral_de_Arequipa%2C_Peru.jpg/1280px-Bas%C3%ADlica_Catedral_de_Arequipa%2C_Peru.jpg',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
  ...
  },
  {
    ...
    name: 'Lima Historic Center - UNESCO World Heritage',
    nameEs: 'Centro Histórico de Lima - Patrimonio Mundial UNESCO',
    type: 'cultural',
    city: 'lima',
    region: 'Lima Region',
    regionEs: 'Región Lima',
    altitude: 154,
    image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Plaza_Mayor_de_Lima%2C_Peru.jpg/1280px-Plaza_Mayor_de_Lima%2C_Peru.jpg',
    imageCredit: 'Wikimedia Commons (CC BY-SA 3.0)',
    description: 'Lima UNESCO-designated Historic Center contains some of the finest Spanish colonial architecture in the Americas, featuring the magnificent Plaza Mayor, the historic Cathedral, impressive monasteries, and beautiful colonial-era buildings with their distinctive wooden balconies. Founded in 1535 by Francisco Pizarro, Lima was the political and economic capital of Spanish South America for nearly three centuries.',
    descriptionEs: 'El Centro Histórico de Lima designado por UNESCO contiene algunas de las más finas arquitecturas coloniales españolas en las Américas, presentando la magnífica Plaza Mayor, la histórica Catedral, impresionantes monasterios, y hermosos edificios de la era colonial con sus distintivos balcones de madera. Fundada en 1535 por Francisco Pizarro, Lima fue la capital política y económica de la Sudamérica española por casi tres siglos.',
    history: 'Lima was founded on January 18, 1535, and quickly became the most important city in Spanish South America. The Cathedral was begun in 1535 and contains the remains of Pizarro. The city grew wealthy from silver mined in Potosí, and its colonial architecture reflects this prosperity. The 1746 earthquake destroyed much of the city, leading to reconstruction in Baroque style. UNESCO designated the Historic Center a World Heritage Site in 1988.',
    historyEs: 'Lima fue fundada el 18 de enero de 1535, y rápidamente se convirtió en la ciudad más importante de la Sudamérica española. La Catedral fue comenzada en 1535 y contiene los restos de Pizarro. La ciudad se enriqueció con la plata extraída en Potosí, y su arquitectura colonial refleja esta prosperidad. El terremoto de 1746 destruyó gran parte de la ciudad, llevando a una reconstrucción en estilo barroco. UNESCO designó el Centro Histórico como Patrimonio Mundial en 1988.',
    highlights: [
      'Plaza Mayor (Plaza de Armas)',
      'Cathedral with Pizarro tomb',
    ...
    durationEs: 'Medio día a día completo',
    difficulty: 'easy',
    entranceFee: 'Most plazas free. San Francisco Monastery S/15 adults, S/3 children. Cathedral S/10.',
    entranceFeeEs: 'Mayoría de plazas gratis. Monasterio San Francisco S/15 adultos, S/3 niños. Catedral S/10.',
    bestTime: 'Year-round. Morning for best light and changing of the guard. December-April warmer.',
    bestTimeEs: 'Todo el año. Mañana para mejor luz y cambio de guardia. Diciembre-abril más cálido.',
    tips: [
      'Watch changing of the guard at noon',
      'San Francisco catacombs fascinating for kids',
      'Walking tour highly recommended',
      'Visit on weekday for fewer crowds',
      'Combine with Chinatown nearby',
      'Try street food around plaza',
      'Evening illumination beautiful',
      'Keep valuables secure'
    ],
    tipsEs: [
      'Mira cambio de guardia al mediodía',
      'Catacumbas de San Francisco fascinantes para niños',
      'Tour a pie muy recomendado',
      'Visita en día de semana para menos multitudes',
      'Combina con Barrio Chino cerca',
      'Prueba comida callejera alrededor de plaza',
      'Iluminación nocturna hermosa',
      'Mantén objetos de valor seguros'
    ],
    nearbyAttractions: ['Chinatown', 'Museo de la Nación', 'Miraflores', 'Barranco'],
    relatedSites: ['miraflores-district', 'barranco-district', 'museo-larco'],
    gettingThere: 'From airport: 45-60 minutes by taxi. Metro Line 1 to Estación Central. Walking distance from most central Lima hotels.',
    gettingThereEs: 'Desde aeropuerto: 45-60 minutos en taxi. Metro Línea 1 a Estación Central. Distancia caminable de mayoría de hoteles céntricos de Lima.',
    facilities: [
      'Restaurants around plaza',
      'Public restrooms',
    ...
    facilitiesEs: [
      'Restaurantes alrededor de plaza',
      'Baños públicos',
      'Presencia de policía turística',
      'Guías turísticos disponibles',
      'Tiendas y mercados',
      'Estación de metro cerca'
    ]
  },
  {
    slug: 'miraflores-district',
    name: 'Miraflores Tourist District',
    nameEs: 'Distrito Turístico de Miraflores',
    type: 'cultural',
    city: 'lima',
    region: 'Lima Region',
    regionEs: 'Región Lima',
    altitude: 79,
    description: 'Miraflores is Lima most popular tourist district, offering a perfect blend of modern amenities, beautiful oceanfront parks, excellent restaurants, safe streets, and ancient ruins right in the city. The malecón (boardwalk) provides stunning Pacific Ocean views, while Kennedy Park offers family-friendly evening activities. The district serves as an ideal base for families exploring Lima.',
    descriptionEs: 'Miraflores es el distrito turístico más popular de Lima, ofreciendo una mezcla perfecta de comodidades modernas, hermosos parques frente al mar, excelentes restaurantes, calles seguras, y ruinas antiguas justo en la ciudad. El malecón proporciona impresionantes vistas del Océano Pacífico, mientras el Parque Kennedy ofrece actividades nocturnas aptas para familias. El distrito sirve como base ideal para familias explorando Lima.',
    history: 'Miraflores was home to pre-Columbian cultures, evidenced by the Huaca Pucllana pyramid. The area developed as a beach resort for Lima elite in the early 20th century and became its own district in 1857. Today it is the cosmopolitan heart of modern Lima, hosting major hotels, the best restaurants, and most visitor attractions.',
    historyEs: 'Miraflores fue hogar de culturas precolombinas, evidenciado por la pirámide Huaca Pucllana. El área se desarrolló como resort de playa para la élite limeña a principios del siglo XX y se convirtió en su propio distrito en 1857. Hoy es el corazón cosmopolita del Lima moderno, albergando principales hoteles, los mejores restaurantes, y mayoría de atracciones turísticas.',
    highlights: [
    ...
    highlightsEs: [
      'Malecón paseo frente al mar',
      'Parque Kennedy',
      'Pirámide Huaca Pucllana',
      'Centro comercial Larcomar',
      'Punto de lanzamiento de parapente',
      'Restaurantes de clase mundial',
      'Barrio seguro',
      'Hermosos parques y jardines'
    ],
    familyRating: 5,
    minAge: 0,
    ...
    difficulty: 'easy',
    entranceFee: 'District is free to explore. Huaca Pucllana S/15. Individual attractions vary.',
    entranceFeeEs: 'Distrito es gratis para explorar. Huaca Pucllana S/15. Atracciones individuales varían.',
    bestTime: 'Year-round. December-April for warmest weather. Evening for Kennedy Park atmosphere.',
    bestTimeEs: 'Todo el año. Diciembre-abril para clima más cálido. Noche para atmósfera del Parque Kennedy.',
    tips: [
      'Best district for family base',
      'Walk the malecón at sunset',
      'Kennedy Park cats are famous',
      'Street performers in evening',
      'Excellent ceviche restaurants',
      'Safe for evening strolls',
      'Many kid-friendly restaurants',
      'Rent bikes on malecón'
    ],
    tipsEs: [
      'Mejor distrito como base familiar',
      'Camina el malecón al atardecer',
      'Gatos del Parque Kennedy son famosos',
      'Artistas callejeros en la noche',
      'Excelentes restaurantes de ceviche',
      'Seguro para caminatas nocturnas',
      'Muchos restaurantes aptos para niños',
      'Alquila bicicletas en el malecón'
    ],
    nearbyAttractions: ['Huaca Pucllana', 'Larcomar', 'Barranco', 'Lima Historic Center'],
    relatedSites: ['huaca-pucllana', 'barranco-district', 'lima-historic-center'],
    gettingThere: 'From airport: 45-90 minutes depending on traffic. Taxi or Uber. No metro service yet. Walking distance to Barranco.',
    gettingThereEs: 'Desde aeropuerto: 45-90 minutos dependiendo del tráfico. Taxi o Uber. Sin servicio de metro aún. Distancia caminable a Barranco.',
    facilities: [
  ...
  {
    slug: 'huaca-huallamarca',
    name: 'Huaca Huallamarca Archaeological Site',
    nameEs: 'Sitio Arqueológico Huaca Huallamarca',
    type: 'archaeological',
    city: 'lima',
    region: 'Lima Region',
    regionEs: 'Región Lima',
    altitude: 120,
    description: 'Huaca Huallamarca is a remarkably well-preserved pre-Columbian adobe pyramid standing incongruously amidst the modern high-rises of San Isidro, Lima wealthiest district. This 2,000-year-old structure served as a ceremonial center and later as a cemetery, with excellent on-site museum displaying mummies, textiles, and artifacts discovered during excavations.',
    descriptionEs: 'Huaca Huallamarca es una pirámide de adobe precolombina notablemente bien preservada que se encuentra incongruentemente entre los modernos rascacielos de San Isidro, el distrito más adinerado de Lima. Esta estructura de 2,000 años sirvió como centro ceremonial y más tarde como cementerio, con excelente museo en el sitio exhibiendo momias, textiles, y artefactos descubiertos durante excavaciones.',
    history: 'Built around 200 BC by the Lima culture, the pyramid served ceremonial purposes for centuries before being converted to a cemetery by later cultures. During excavations, archaeologists discovered numerous mummified remains along with grave offerings. The pyramid was restored in the 1950s after having been used as a quarry for construction materials. Today it stands as a reminder of Lima long pre-Hispanic heritage.',
    historyEs: 'Construida alrededor del 200 a.C. por la cultura Lima, la pirámide sirvió propósitos ceremoniales por siglos antes de ser convertida en cementerio por culturas posteriores. Durante excavaciones, arqueólogos descubrieron numerosos restos momificados junto con ofrendas funerarias. La pirámide fue restaurada en los años 1950 después de haber sido usada como cantera para materiales de construcción. Hoy permanece como recordatorio de la larga herencia prehispánica de Lima.',
    highlights: [
      'Well-preserved adobe pyramid',
      'On-site museum with mummies',
      'Ancient textiles display',
      'Contrast with modern city',
      'Evening illumination',
      'Small but significant site',
      'Less crowded than Huaca Pucllana',
      'Educational for children'
    ],
    highlightsEs: [
      'Pirámide de adobe bien preservada',
      'Museo en el sitio con momias',
      'Exhibición de textiles antiguos',
      'Contraste con ciudad moderna',
      'Iluminación nocturna',
      'Sitio pequeño pero significativo',
      'Menos concurrido que Huaca Pucllana',
    ...
    durationEs: '1-1.5 horas',
    difficulty: 'easy',
    entranceFee: 'S/5 adults, S/1 children. Free on Sundays.',
    entranceFeeEs: 'S/5 adultos, S/1 niños. Gratis los domingos.',
    bestTime: 'Year-round. Morning or late afternoon for best light. Evening for illuminated pyramid.',
    bestTimeEs: 'Todo el año. Mañana o tarde para mejor luz. Noche para pirámide iluminada.',
    tips: [
      'Combine with nearby parks',
      'Free on Sundays',
      'Museum has English explanations',
      'Kids fascinated by mummies',
      'Less crowded alternative',
      'Good photo opportunities',
      'Air-conditioned museum',
      'Near upscale restaurants'
    ],
    tipsEs: [
      'Combina con parques cercanos',
      'Gratis los domingos',
      'Museo tiene explicaciones en inglés',
      'Niños fascinados por momias',
      'Alternativa menos concurrida',
      'Buenas oportunidades de fotos',
      'Museo con aire acondicionado',
      'Cerca de restaurantes de lujo'
    ],
    nearbyAttractions: ['El Olivar Park', 'Miraflores', 'Golf Los Incas', 'Country Club Lima'],
    relatedSites: ['huaca-pucllana', 'museo-larco', 'lima-historic-center'],
    gettingThere: 'Located in San Isidro district. 15 minutes from Miraflores by taxi. Walking distance from many business hotels.',
    gettingThereEs: 'Ubicado en distrito de San Isidro. 15 minutos desde Miraflores en taxi. Distancia caminable de muchos hoteles de negocios.',
    facilities: [
      'On-site museum',
      'Clean restrooms',
      'Ticket office',
    ...
    facilitiesEs: [
      ...
      'Baños limpios',
      'Boletería',
      'Bancas para descanso',
      'Iluminado de noche',
      'Servicios de guía disponibles'
    ]
  },
  {
    slug: 'barranco-district',
    name: 'Barranco Bohemian District',
    nameEs: 'Distrito Bohemio de Barranco',
    type: 'cultural',
    city: 'lima',
    region: 'Lima Region',
    regionEs: 'Región Lima',
    altitude: 58,
    description: 'Barranco is Lima most charming and artistic neighborhood, featuring colorful colonial architecture, street art murals, the famous Bridge of Sighs, and a vibrant cultural scene with galleries, cafes, and live music venues. This bohemian district offers families a more relaxed atmosphere than busy Miraflores while remaining safe and walkable with plenty of family-friendly activities.',
    descriptionEs: 'Barranco es el barrio más encantador y artístico de Lima, presentando colorida arquitectura colonial, murales de arte callejero, el famoso Puente de los Suspiros, y una vibrante escena cultural con galerías, cafés, y locales de música en vivo. Este distrito bohemio ofrece a familias una atmósfera más relajada que el ocupado Miraflores mientras permanece seguro y caminable con muchas actividades aptas para familias.',
    history: 'Barranco developed as a beach retreat for Lima wealthy families in the late 19th century, with grand summer homes built along the clifftops. When the area declined in the mid-20th century, artists and bohemians moved in, transforming it into a cultural hub. The legendary Bridge of Sighs, built in 1876, connects the main plaza to the beach and is surrounded by romantic legends.',
    historyEs: 'Barranco se desarrolló como retiro de playa para familias adineradas de Lima a finales del siglo XIX, con grandes casas de verano construidas a lo largo de los acantilados. Cuando el área declinó a mediados del siglo XX, artistas y bohemios se mudaron, transformándolo en un centro cultural. El legendario Puente de los Suspiros, construido en 1876, conecta la plaza principal con la playa y está rodeado de leyendas románticas.',
    highlights: [
    ...
    highlightsEs: [
      ...
      'Coloridos murales de arte callejero',
    ...
    difficulty: 'easy',
    entranceFee: 'Free to explore. MATE museum S/20. Individual shops and cafes vary.',
    entranceFeeEs: 'Gratis para explorar. Museo MATE S/20. Tiendas y cafés individuales varían.',
    bestTime: 'Year-round. Late afternoon and evening for best atmosphere. Weekend for street performers.',
    bestTimeEs: 'Todo el año. Tarde y noche para mejor atmósfera. Fin de semana para artistas callejeros.',
    tips: [
      'Walk from Miraflores along malecón',
      'Cross Bridge of Sighs holding breath',
      'Try picarones (local donuts)',
      'Evening has best atmosphere',
    ...
    tipsEs: [
      ...
      'Cruza Puente de los Suspiros aguantando respiración',
      'Prueba picarones',
      'Noche tiene mejor atmósfera',
      'Seguro para paseos familiares nocturnos',
      'Niños aman artistas callejeros',
      'Geniales heladerías',
      'Combina con visita a Miraflores'
    ],
    nearbyAttractions: ['Miraflores', 'Chorrillos beaches', 'MATE Museum', 'Lima Historic Center'],
    relatedSites: ['miraflores-district', 'lima-historic-center', 'museo-de-arte-de-lima'],
    gettingThere: 'From Miraflores: 10-minute taxi or 30-minute walk along malecón. From airport: 50-90 minutes by taxi.',
    gettingThereEs: 'Desde Miraflores: 10 minutos en taxi o 30 minutos caminando por el malecón. Desde aeropuerto: 50-90 minutos en taxi.',
    facilities: [
    ...
    facilitiesEs: [
      ...
      'Tiendas de artesanías',
      'Baños públicos cerca de plaza',
      'Hoteles y hostales',
      'Cajeros automáticos',
      'Oportunidades de fotos de arte callejero'
    ]
  },
  {
    slug: 'nazca-lines',
    name: 'Nazca Lines Geoglyphs',
    nameEs: 'Líneas de Nazca Geoglifos',
    type: 'archaeological',
    city: 'nazca',
    region: 'Ica Region',
    regionEs: 'Región Ica',
    altitude: 588,
    description: 'The Nazca Lines are one of the world most mysterious archaeological wonders - enormous geoglyphs etched into the desert floor over 2,000 years ago depicting animals, plants, and geometric shapes that can only be fully appreciated from the air. This UNESCO World Heritage Site stretches across 450 square kilometers and includes over 70 biomorph designs including a hummingbird, monkey, spider, and condor that continue to puzzle researchers.',
    descriptionEs: 'Las Líneas de Nazca son una de las maravillas arqueológicas más misteriosas del mundo - enormes geoglifos grabados en el suelo del desierto hace más de 2,000 años representando animales, plantas, y formas geométricas que solo pueden apreciarse completamente desde el aire. Este Sitio de Patrimonio Mundial UNESCO se extiende por 450 kilómetros cuadrados e incluye más de 70 diseños biomorfos incluyendo colibrí, mono, araña, y cóndor que continúan desconcertando investigadores.',
    history: 'Created by the Nazca culture between 500 BCE and 500 CE, these massive desert drawings were made by removing the reddish pebbles covering the ground to reveal the lighter ground beneath. The dry, windless, stable climate has preserved them for over 2,000 years. German mathematician Maria Reiche dedicated her life to studying and protecting the lines, proposing they formed an astronomical calendar. Today multiple theories exist about their purpose, from ritual pathways to water worship ceremonies.',
    historyEs: 'Creadas por la cultura Nazca entre 500 AEC y 500 EC, estos masivos dibujos del desierto fueron hechos removiendo las piedrecillas rojizas que cubren el suelo para revelar el terreno más claro debajo. El clima seco, sin viento, y estable los ha preservado por más de 2,000 años. La matemática alemana María Reiche dedicó su vida a estudiar y proteger las líneas, proponiendo que formaban un calendario astronómico. Hoy existen múltiples teorías sobre su propósito, desde caminos rituales hasta ceremonias de adoración al agua.',
    highlights: [
      'Hummingbird figure (96 meters)',
      'Monkey figure with spiral tail',
      'Spider geoglyph',
      'Condor with 130-meter wingspan',
    ...
    highlightsEs: [
      'Figura del colibrí (96 metros)',
      'Figura del mono con cola espiral',
      'Geoglifo de araña',
      'Cóndor con envergadura de 130 metros',
      'Figura del astronauta',
      'Vistas desde torre de observación',
      'Museo María Reiche',
      'Planetario de Nazca'
    ],
    familyRating: 4,
    ...
    difficulty: 'easy',
    entranceFee: 'Observation tower S/3. Flights USD 80-120 per person. Maria Reiche Museum S/5.',
    entranceFeeEs: 'Torre de observación S/3. Vuelos USD 80-120 por persona. Museo María Reiche S/5.',
    bestTime: 'Year-round. Morning flights have clearest visibility. May-November best weather.',
    bestTimeEs: 'Todo el año. Vuelos matutinos tienen mejor visibilidad. Mayo-noviembre mejor clima.',
    tips: [
      'Book flights early morning for best visibility',
      'Eat light breakfast before flight',
      'Motion sickness medication recommended',
      'Children under 5 may not enjoy flights',
      'Observation tower is free alternative',
      'Maria Reiche Museum excellent for kids',
      'Combine with Chauchilla Cemetery',
      'Stay overnight in Nazca town'
    ],
    tipsEs: [
      'Reserva vuelos temprano en la mañana para mejor visibilidad',
      'Come desayuno ligero antes del vuelo',
      'Se recomienda medicina para mareo',
      'Niños menores de 5 pueden no disfrutar vuelos',
      'Torre de observación es alternativa gratuita',
      'Museo María Reiche excelente para niños',
      'Combina con Cementerio Chauchilla',
      'Quédate una noche en pueblo de Nazca'
    ],
    nearbyAttractions: ['Chauchilla Cemetery', 'Cantalloc Aqueducts', 'Maria Reiche Museum', 'Nazca town'],
    relatedSites: ['chauchilla-cemetery', 'paracas-national-reserve', 'huacachina-oasis'],
    gettingThere: 'From Lima: 7-hour bus ride or 1-hour flight to Nazca. From Arequipa: 9 hours by bus. Tour buses from Lima available.',
    gettingThereEs: 'Desde Lima: 7 horas en bus o 1 hora de vuelo a Nazca. Desde Arequipa: 9 horas en bus. Buses turísticos desde Lima disponibles.',
    facilities: [
      'Airport for scenic flights',
      'Observation tower',
      'Visitor center',
      'Hotels in Nazca town',
      'Restaurants',
      'Tour agencies'
    ],
    facilitiesEs: [
      'Aeropuerto para vuelos escénicos',
      'Torre de observación',
      'Centro de visitantes',
      'Hoteles en pueblo de Nazca',
      'Restaurantes',
      'Agencias de turismo'
    ]
  },
  {
    slug: 'caral-archaeological-site',
    name: 'Caral Sacred City Archaeological Site',
    nameEs: 'Sitio Arqueológico Ciudad Sagrada de Caral',
    type: 'archaeological',
    city: 'barranca',
    region: 'Lima Region',
    regionEs: 'Región Lima',
    altitude: 350,
    description: 'Caral is the oldest known city in the Americas and one of the cradles of world civilization, dating back 5,000 years - contemporary with the Egyptian pyramids. This UNESCO World Heritage Site features six monumental pyramids, sunken circular plazas, and residential areas that housed an advanced society that achieved remarkable urban planning, agricultural irrigation, and musical development without warfare or fortifications.',
    descriptionEs: 'Caral es la ciudad más antigua conocida de las Américas y una de las cunas de la civilización mundial, con 5,000 años de antigüedad - contemporánea con las pirámides egipcias. Este Sitio de Patrimonio Mundial UNESCO presenta seis pirámides monumentales, plazas circulares hundidas, y áreas residenciales que albergaron una sociedad avanzada que logró notable planificación urbana, irrigación agrícola, y desarrollo musical sin guerra o fortificaciones.',
    history: 'The Caral civilization flourished from 3000-1800 BCE in the Supe Valley, making it contemporaneous with ancient Egypt, Mesopotamia, India, and China as one of the six independent centers of civilization. Archaeologist Ruth Shady discovered and has led excavations since 1994, revealing a peaceful society focused on trade, astronomy, and agriculture. The site shows no evidence of warfare - no weapons, defensive walls, or battle injuries in human remains have been found.',
    historyEs: 'La civilización Caral floreció de 3000-1800 AEC en el Valle de Supe, haciéndola contemporánea con el antiguo Egipto, Mesopotamia, India, y China como uno de los seis centros independientes de civilización. La arqueóloga Ruth Shady descubrió y ha liderado excavaciones desde 1994, revelando una sociedad pacífica enfocada en comercio, astronomía, y agricultura. El sitio no muestra evidencia de guerra - no se han encontrado armas, murallas defensivas, o heridas de batalla en restos humanos.',
    highlights: [
      'Pyramid of the Amphitheater',
      'Major Pyramid (largest structure)',
      'Circular Plaza complex',
      'Gallery Pyramid',
      'Ancient quipu (recording devices)',
      '32 wind instruments found',
      'Irrigation canals',
      'Residential sectors'
    ],
    highlightsEs: [
      'Pirámide del Anfiteatro',
      'Pirámide Mayor (estructura más grande)',
      'Complejo de Plaza Circular',
      'Pirámide de la Galería',
      'Antiguos quipus (dispositivos de registro)',
      '32 instrumentos de viento encontrados',
      'Canales de irrigación',
      'Sectores residenciales'
    ],
    familyRating: 4,
    minAge: 6,
    duration: 'Full day from Lima',
    durationEs: 'Día completo desde Lima',
    difficulty: 'moderate',
    entranceFee: 'Adults S/11, children S/1. Guided tours included in entrance.',
    entranceFeeEs: 'Adultos S/11, niños S/1. Tours guiados incluidos en entrada.',
    bestTime: 'Year-round. Dry season April-November. Morning visits avoid afternoon heat.',
    bestTimeEs: 'Todo el año. Temporada seca abril-noviembre. Visitas matutinas evitan calor de tarde.',
    tips: [
      'Depart Lima early morning',
      'Bring sun protection - no shade',
      'Carry plenty of water',
      'Guided tour mandatory and included',
      'Wear comfortable walking shoes',
      ...
      'Photography allowed',
      'Combine with beach lunch in Barranca'
    ],
    tipsEs: [
      'Sal de Lima temprano en la mañana',
      'Trae protección solar - no hay sombra',
      'Lleva mucha agua',
      'Tour guiado obligatorio e incluido',
      'Usa zapatos cómodos para caminar',
      'Gran experiencia educativa para niños',
      'Fotografía permitida',
      'Combina con almuerzo en playa en Barranca'
    ],
    nearbyAttractions: ['Supe Valley', 'Barranca beaches', 'Vichama archaeological site', 'Fortress of Paramonga'],
    relatedSites: ['pachacamac', 'chan-chan', 'sechin-archaeological-site'],
    gettingThere: 'From Lima: 3.5-hour drive (200 km) via Panamericana Norte. Tours depart from Lima. From Barranca: 25 km inland.',
    gettingThereEs: 'Desde Lima: 3.5 horas en auto (200 km) vía Panamericana Norte. Tours salen desde Lima. Desde Barranca: 25 km tierra adentro.',
    facilities: [
      'Visitor center',
      'Site museum',
      'Restrooms',
  ...
  {
    slug: 'qeswachaka-inca-bridge',
    name: 'Q\'eswachaka Inca Rope Bridge',
    nameEs: 'Puente Inca Q\'eswachaka',
    type: 'cultural',
    city: 'canas',
    region: 'Cusco Region',
    regionEs: 'Región Cusco',
    altitude: 3700,
    description: 'Q\'eswachaka is the last remaining Inca rope bridge in existence, a living testament to ancient engineering traditions maintained for over 600 years. Every June, four Quechua-speaking communities gather for a three-day festival to rebuild the 33-meter suspension bridge entirely from handwoven q\'oya grass ropes using traditional techniques passed down through generations.',
    descriptionEs: 'Q\'eswachaka es el último puente colgante Inca existente, un testamento vivo a tradiciones de ingeniería antigua mantenidas por más de 600 años. Cada junio, cuatro comunidades quechua-hablantes se reúnen para un festival de tres días para reconstruir el puente de suspensión de 33 metros enteramente de cuerdas de pasto q\'oya tejidas a mano usando técnicas tradicionales transmitidas por generaciones.',
    history: 'During the Inca Empire, hundreds of rope bridges spanned the Andes, forming critical links in the Qhapaq Ñan road system. When Spanish conquistadors arrived, most bridges fell into disuse, but the communities around Q\'eswachaka continued their tradition. In 2013, UNESCO recognized the annual renewal ceremony as Intangible Cultural Heritage of Humanity. The bridge spans the Apurimac River at the same location used for centuries.',
    historyEs: 'Durante el Imperio Inca, cientos de puentes de cuerda cruzaban los Andes, formando enlaces críticos en el sistema de caminos Qhapaq Ñan. Cuando llegaron los conquistadores españoles, la mayoría de puentes cayeron en desuso, pero las comunidades alrededor de Q\'eswachaka continuaron su tradición. En 2013, UNESCO reconoció la ceremonia anual de renovación como Patrimonio Cultural Inmaterial de la Humanidad. El puente cruza el Río Apurímac en el mismo lugar usado por siglos.',
    highlights: [
      'Last surviving Inca rope bridge',
      'Annual renewal festival (June)',
      'Traditional grass rope weaving',
    ...
    highlightsEs: [
      ...
      'Festival anual de renovación (junio)',
      'Tejido tradicional de cuerdas de pasto',
      'Cruzar el puente histórico',
      'Vistas del cañón del Río Apurímac',
      'Interacción con comunidad quechua',
      'Sitio de Patrimonio Inmaterial UNESCO',
      'Ceremonias tradicionales y música'
    ],
    familyRating: 4,
    minAge: 7,
    duration: 'Full day from Cusco',
    durationEs: 'Día completo desde Cusco',
    difficulty: 'moderate',
    entranceFee: 'Community fee approximately S/10-20. Festival period may have different fees.',
    entranceFeeEs: 'Tarifa comunitaria aproximadamente S/10-20. Período del festival puede tener tarifas diferentes.',
    bestTime: 'Second Sunday of June for renewal festival. Year-round to see and cross the bridge.',
    bestTimeEs: 'Segundo domingo de junio para festival de renovación. Todo el año para ver y cruzar el puente.',
    tips: [
      'June festival is spectacular but crowded',
      'Book tours well in advance for festival',
      'Bridge is safe to cross year-round',
      'Wear sturdy shoes for rocky terrain',
      'Bring warm layers - high altitude',
      'Consider altitude acclimatization first',
      'Bring snacks - limited food options',
      'Great cultural learning for children'
    ],
    tipsEs: [
      'Festival de junio es espectacular pero concurrido',
      'Reserva tours con anticipación para festival',
      'Puente es seguro para cruzar todo el año',
      'Usa zapatos resistentes para terreno rocoso',
      'Trae capas abrigadas - alta altitud',
      'Considera aclimatación a altitud primero',
      'Trae snacks - opciones limitadas de comida',
      'Gran aprendizaje cultural para niños'
    ],
    nearbyAttractions: ['Cusco', 'Raqchi Temple', 'Andahuaylillas Church', 'Lake Titicaca'],
    relatedSites: ['raqchi-temple', 'andahuaylillas-church', 'cusco-historic-center'],
    gettingThere: 'From Cusco: 4-hour drive (100 km) toward Puno, then dirt road to community. Tours available from Cusco.',
    gettingThereEs: 'Desde Cusco: 4 horas en auto (100 km) hacia Puno, luego camino de tierra a comunidad. Tours disponibles desde Cusco.',
    facilities: [
      ...
      'Traditional food during festival'
    ],
    facilitiesEs: [
      'Instalaciones comunitarias básicas',
      'Guías locales',
      'Plataformas de observación',
      'Baños limitados',
      'Artesanías en venta',
      'Comida tradicional durante festival'
    ]
  },
  {
    slug: 'revash-mausoleums',
    name: 'Revash Cliff Mausoleums',
    nameEs: 'Mausoleos de Revash',
    type: 'archaeological',
    city: 'chachapoyas',
    region: 'Amazonas Region',
    regionEs: 'Región Amazonas',
    altitude: 2800,
    description: 'The Revash Mausoleums are extraordinary funerary structures built into limestone cliff faces by the Chachapoya people, featuring house-shaped tombs painted in vivid red and cream colors that have survived for over 500 years. These remarkable cliff-side burial chambers offer insight into Chachapoya beliefs about the afterlife and their incredible construction skills in seemingly impossible locations.',
    descriptionEs: 'Los Mausoleos de Revash son estructuras funerarias extraordinarias construidas en acantilados de piedra caliza por el pueblo Chachapoya, presentando tumbas en forma de casa pintadas en vívidos colores rojo y crema que han sobrevivido por más de 500 años. Estas notables cámaras de entierro en acantilados ofrecen visión sobre creencias Chachapoya sobre la vida después de la muerte y sus increíbles habilidades de construcción en ubicaciones aparentemente imposibles.',
    history: 'Built by the Chachapoya civilization between 1100-1300 CE, these cliff tombs housed the mummified remains of important community members. The Chachapoya, known as the "Warriors of the Clouds," believed the dead needed proper homes in the afterlife, constructing elaborate multi-story buildings on cliff ledges accessible only by rope. The red paint represented life force and the paintings depicted daily life activities the deceased would continue in the afterlife.',
    historyEs: 'Construidos por la civilización Chachapoya entre 1100-1300 EC, estas tumbas en acantilados albergaron los restos momificados de miembros importantes de la comunidad. Los Chachapoya, conocidos como los "Guerreros de las Nubes," creían que los muertos necesitaban hogares apropiados en la vida después de la muerte, construyendo elaborados edificios de varios pisos en repisas de acantilados accesibles solo por cuerda. La pintura roja representaba fuerza vital y las pinturas representaban actividades de vida diaria que el difunto continuaría en la otra vida.',
    highlights: [
      'House-shaped cliff tombs',
      'Original red and cream paintings',
      'Multiple tomb structures',
      'Scenic mountain valley views',
      'Chachapoya funerary art',
      'Well-preserved pictographs',
      'Cloud forest setting',
      'Traditional village of Santo Tomás'
    ],
    highlightsEs: [
      'Tumbas en acantilado en forma de casa',
      'Pinturas originales rojas y crema',
      'Múltiples estructuras de tumbas',
      'Vistas escénicas del valle de montaña',
      'Arte funerario Chachapoya',
      'Pictografías bien preservadas',
      'Entorno de bosque nuboso',
    ...
    durationEs: 'Medio día desde Chachapoyas',
    difficulty: 'moderate',
    entranceFee: 'S/5 adults, S/2 students. Local guide recommended.',
    entranceFeeEs: 'S/5 adultos, S/2 estudiantes. Guía local recomendado.',
    bestTime: 'Dry season May-September. Morning for best lighting on cliff faces.',
    bestTimeEs: 'Temporada seca mayo-septiembre. Mañana para mejor iluminación en acantilados.',
    tips: [
      'Hire local guide in Santo Tomás',
      'Moderate uphill hike required',
      'Bring binoculars for detail viewing',
      'Good walking shoes essential',
      'Bring water and snacks',
      'Best combined with Karajía visit',
      'Photography excellent in morning',
      'Respect sacred site - no climbing'
    ],
    tipsEs: [
      'Contrata guía local en Santo Tomás',
      'Se requiere caminata moderada cuesta arriba',
      'Trae binoculares para ver detalles',
      'Buenos zapatos para caminar esenciales',
      'Trae agua y snacks',
      'Mejor combinado con visita a Karajía',
      'Fotografía excelente en la mañana',
      'Respeta sitio sagrado - no escales'
    ],
    nearbyAttractions: ['Karajía sarcophagi', 'Kuelap', 'Gocta waterfall', 'Chachapoyas town'],
    relatedSites: ['kuelap-fortress', 'gocta-waterfall', 'karajia-sarcophagi'],
    gettingThere: 'From Chachapoyas: 1-hour drive (60 km) to Santo Tomás, then 20-minute hike to viewpoint. Tours available.',
    gettingThereEs: 'Desde Chachapoyas: 1 hora en auto (60 km) a Santo Tomás, luego 20 minutos de caminata a mirador. Tours disponibles.',
    facilities: [
      'Viewing platforms',
      'Local guides in Santo Tomás',
      'Basic facilities in village',
      'Parking area',
      'Small shops',
      'Walking trail'
    ],
    facilitiesEs: [
      'Plataformas de observación',
      'Guías locales en Santo Tomás',
      'Instalaciones básicas en pueblo',
      'Área de estacionamiento',
      'Pequeñas tiendas',
  ...
  {
    slug: 'chauchilla-cemetery',
    name: 'Chauchilla Cemetery Archaeological Site',
    nameEs: 'Cementerio de Chauchilla Sitio Arqueológico',
    type: 'archaeological',
    city: 'nazca',
    region: 'Ica Region',
    regionEs: 'Región Ica',
    altitude: 460,
    description: 'Chauchilla Cemetery is a remarkable open-air archaeological site containing well-preserved pre-Inca mummies still sitting in their original burial positions, surrounded by fragments of pottery, textiles, and bones. The dry desert climate has naturally preserved these 1,000-year-old remains, offering families an unforgettable glimpse into ancient Peruvian funerary practices and beliefs about the afterlife.',
    descriptionEs: 'El Cementerio de Chauchilla es un notable sitio arqueológico al aire libre que contiene momias pre-Incas bien preservadas aún sentadas en sus posiciones de entierro originales, rodeadas de fragmentos de cerámica, textiles, y huesos. El clima seco del desierto ha preservado naturalmente estos restos de 1,000 años, ofreciendo a familias una visión inolvidable de las prácticas funerarias peruanas antiguas y creencias sobre la vida después de la muerte.',
    history: 'Used as a burial ground by the Nazca and Ica cultures from approximately 200 CE to 900 CE, Chauchilla contains remains of people who lived during the same era as the creators of the famous Nazca Lines. The site was heavily looted during the 20th century, with bones and artifacts scattered across the desert. Since the 1990s, archaeologists have restored and protected twelve tombs with their original occupants. The characteristic seated position with knees drawn up was intended to prepare the deceased for rebirth.',
    historyEs: 'Usado como cementerio por las culturas Nazca e Ica desde aproximadamente 200 EC hasta 900 EC, Chauchilla contiene restos de personas que vivieron durante la misma era que los creadores de las famosas Líneas de Nazca. El sitio fue fuertemente saqueado durante el siglo XX, con huesos y artefactos dispersos por el desierto. Desde los años 1990, arqueólogos han restaurado y protegido doce tumbas con sus ocupantes originales. La posición sentada característica con rodillas levantadas estaba destinada a preparar al difunto para el renacimiento.',
    highlights: [
      'Well-preserved ancient mummies',
      'Original burial positions',
      'Preserved hair and skin',
      'Ancient textiles and pottery',
      'Desert landscape setting',
      'Multiple tomb displays',
      'Pre-Inca funerary customs',
      'Natural preservation site'
    ],
    highlightsEs: [
      'Momias antiguas bien preservadas',
      'Posiciones de entierro originales',
      'Cabello y piel preservados',
      'Textiles y cerámica antiguos',
      'Entorno de paisaje desértico',
      'Múltiples exhibiciones de tumbas',
      'Costumbres funerarias pre-Incas',
      'Sitio de preservación natural'
    ],
    familyRating: 3,
    minAge: 8,
    duration: '1-2 hours',
    durationEs: '1-2 horas',
    difficulty: 'easy',
    entranceFee: 'S/8 adults, S/3 students. Tours typically S/40-60 including transport.',
    entranceFeeEs: 'S/8 adultos, S/3 estudiantes. Tours típicamente S/40-60 incluyendo transporte.',
    bestTime: 'Year-round. Morning or late afternoon to avoid midday desert heat.',
    bestTimeEs: 'Todo el año. Mañana o tarde para evitar calor del mediodía del desierto.',
    tips: [
      'Consider if appropriate for your children',
      'Combine with Nazca Lines flight',
      'Tours include transport from Nazca',
      'Bring sun protection - no shade',
      'Photography allowed',
      'Respectful behavior required',
      'Excellent educational opportunity',
      'Desert can be windy - bring layers'
    ],
    tipsEs: [
      'Considera si es apropiado para tus niños',
      'Combina con vuelo de Líneas de Nazca',
      'Tours incluyen transporte desde Nazca',
      'Trae protección solar - no hay sombra',
      'Fotografía permitida',
      'Se requiere comportamiento respetuoso',
      'Excelente oportunidad educativa',
      'Desierto puede ser ventoso - trae capas'
    ],
    nearbyAttractions: ['Nazca Lines', 'Cantalloc Aqueducts', 'Maria Reiche Museum', 'Nazca town'],
    relatedSites: ['nazca-lines', 'paracas-national-reserve', 'huacachina-oasis'],
    gettingThere: 'From Nazca: 30 km south (30 minutes by car). No public transport - tours or taxi required.',
    gettingThereEs: 'Desde Nazca: 30 km al sur (30 minutos en auto). No hay transporte público - se requiere tour o taxi.',
    facilities: [
      'Entrance gate',
      'Walking paths between tombs',
      'Information signs',
      'Parking area',
    ...
    facilitiesEs: [
      'Puerta de entrada',
      'Senderos entre tumbas',
      'Letreros informativos',
      'Área de estacionamiento',
      'Estructuras básicas de sombra',
      'Servicios de guía disponibles'
    ]
  },
  {
    slug: 'marcahuasi-stone-forest',
    name: 'Marcahuasi Stone Forest',
    nameEs: 'Bosque de Piedras de Marcahuasi',
    type: 'natural',
    city: 'huarochiri',
    ...
    regionEs: 'Región Lima',
    altitude: 4000,
    description: 'Marcahuasi is a mysterious high-altitude plateau featuring enormous rock formations that many believe resemble human faces, animals, and mythological figures carved by an unknown ancient civilization. Located just 80 km from Lima at 4,000 meters, this enigmatic site attracts visitors seeking to understand whether the formations are natural erosion or evidence of a lost advanced culture.',
    descriptionEs: 'Marcahuasi es una misteriosa meseta de alta altitud con enormes formaciones rocosas que muchos creen se asemejan a rostros humanos, animales, y figuras mitológicas talladas por una civilización antigua desconocida. Ubicada a solo 80 km de Lima a 4,000 metros, este enigmático sitio atrae visitantes que buscan entender si las formaciones son erosión natural o evidencia de una cultura avanzada perdida.',
    history: 'Brought to international attention by Daniel Ruzo in 1952, Marcahuasi has been the subject of debate between those who believe the formations are sculptured by an ancient pre-Inca civilization and geologists who attribute them to natural erosion. Ruzo named formations like the "Monument to Humanity," "The African Head," and "The Condor." Archaeological evidence shows the plateau was used by pre-Columbian peoples, though the origin of the rock shapes remains controversial and adds to the sites mystical appeal.',
    historyEs: 'Llevado a atención internacional por Daniel Ruzo en 1952, Marcahuasi ha sido tema de debate entre quienes creen que las formaciones fueron esculpidas por una antigua civilización pre-Inca y geólogos que las atribuyen a erosión natural. Ruzo nombró formaciones como el "Monumento a la Humanidad," "La Cabeza Africana," y "El Cóndor." Evidencia arqueológica muestra que la meseta fue usada por pueblos pre-colombinos, aunque el origen de las formas rocosas permanece controversial y añade al atractivo místico del sitio.',
    highlights: [
      'Monument to Humanity rock face',
      'The African Head formation',
      'El Condor rock formation',
      'High altitude plateau camping',
      'Stunning Andean panoramas',
    ...
    highlightsEs: [
      ...
      'Formación de Cabeza Africana',
      'Formación rocosa El Cóndor',
      'Campamento en meseta de alta altitud',
      'Impresionantes panoramas andinos',
      'Atmósfera misteriosa',
      'Oportunidades de observación de estrellas',
      'Formaciones rocosas únicas'
    ],
    familyRating: 3,
    minAge: 10,
    duration: '2-3 days recommended (overnight camping)',
    durationEs: '2-3 días recomendados (campamento nocturno)',
    difficulty: 'challenging',
    entranceFee: 'S/5 community entrance fee. Camping fees additional.',
    entranceFeeEs: 'S/5 tarifa de entrada comunitaria. Tarifas de campamento adicionales.',
    bestTime: 'May-October dry season. June-August for clearest skies and star gazing.',
    bestTimeEs: 'Mayo-octubre temporada seca. Junio-agosto para cielos más claros y observación de estrellas.',
    tips: [
      'Altitude acclimatization essential',
      'Bring all supplies - none available on plateau',
      'Warm sleeping gear required',
      'Strong hiking boots needed',
      'Hire local guide from San Pedro',
      'Full moon weekends magical',
      'Water and food must be carried',
      'Not suitable for young children'
    ],
    tipsEs: [
      'Aclimatación a la altitud esencial',
      'Trae todos los suministros - ninguno disponible en meseta',
      'Se requiere equipo de dormir abrigado',
      'Se necesitan botas de caminata resistentes',
      'Contrata guía local de San Pedro',
      'Fines de semana de luna llena mágicos',
      'Agua y comida deben cargarse',
      'No apto para niños pequeños'
    ],
    nearbyAttractions: ['San Pedro de Casta village', 'Lima', 'Chosica'],
    relatedSites: ['huascaran-national-park', 'rainbow-mountain'],
    gettingThere: 'From Lima: Bus to Chosica (1.5 hours), then colectivo to San Pedro de Casta (3 hours), then 3-4 hour hike to plateau.',
    gettingThereEs: 'Desde Lima: Bus a Chosica (1.5 horas), luego colectivo a San Pedro de Casta (3 horas), luego 3-4 horas de caminata a meseta.',
    facilities: [
      'Camping areas',
      'Community guides in San Pedro',
      'Basic lodging in village',
    ...
    facilitiesEs: [
      'Áreas de campamento',
      'Guías comunitarios en San Pedro',
      'Alojamiento básico en pueblo',
  ...
  {
    slug: 'tambopata-national-reserve',
    name: 'Tambopata National Reserve',
    nameEs: 'Reserva Nacional Tambopata',
    type: 'natural',
    city: 'puerto-maldonado',
    ...
    regionEs: 'Región Madre de Dios',
    altitude: 200,
    description: 'Tambopata National Reserve protects 274,690 hectares of pristine Amazon rainforest, showcasing one of the most biodiverse ecosystems on Earth with over 600 bird species, 1,200 butterfly species, and rare wildlife including giant otters, jaguars, and macaws. The reserve famous clay licks attract hundreds of parrots and macaws each morning, creating one of wildlife most spectacular shows.',
    descriptionEs: 'La Reserva Nacional Tambopata protege 274,690 hectáreas de selva amazónica prístina, mostrando uno de los ecosistemas más biodiversos de la Tierra con más de 600 especies de aves, 1,200 especies de mariposas, y fauna rara incluyendo nutrias gigantes, jaguares, y guacamayos. Los famosos collpas de arcilla de la reserva atraen cientos de loros y guacamayos cada mañana, creando uno de los espectáculos más espectaculares de la vida silvestre.',
    history: 'Established in 2000 to protect the biodiversity of the southeastern Peruvian Amazon, Tambopata grew from smaller protected zones created in the 1990s. The reserve borders Bahuaja-Sonene National Park and connects to Bolivian protected areas, forming a massive conservation corridor. The region was historically home to the Ese Eja indigenous people who still maintain territories within the buffer zones. The reserve name comes from the Tambopata River, a major tributary of the Madre de Dios.',
    historyEs: 'Establecida en 2000 para proteger la biodiversidad de la Amazonía peruana suroriental, Tambopata creció de zonas protegidas más pequeñas creadas en los años 1990. La reserva limita con el Parque Nacional Bahuaja-Sonene y conecta con áreas protegidas bolivianas, formando un masivo corredor de conservación. La región fue históricamente hogar del pueblo indígena Ese Eja que aún mantiene territorios dentro de las zonas de amortiguamiento. El nombre de la reserva viene del Río Tambopata, un afluente importante del Madre de Dios.',
    highlights: [
      'Macaw clay lick (colpa)',
      ...
      'Piranha fishing',
      'Indigenous community visits',
      'Tapir and caiman spotting'
    ],
    highlightsEs: [
      'Collpa de guacamayos',
      'Observación de nutrias gigantes',
      'Pasarelas de dosel',
      'Vida silvestre de lagos de herradura',
      'Caminatas nocturnas en selva',
      'Pesca de pirañas',
      'Visitas a comunidades indígenas',
      'Avistamiento de tapires y caimanes'
    ],
    familyRating: 4,
    minAge: 5,
    duration: '3-5 days recommended',
    durationEs: '3-5 días recomendados',
    difficulty: 'moderate',
    entranceFee: 'Reserve entrance S/30 adults, S/8 children. Lodge packages vary widely.',
    entranceFeeEs: 'Entrada a reserva S/30 adultos, S/8 niños. Paquetes de lodge varían ampliamente.',
    bestTime: 'Dry season May-October for easier travel. Wet season December-March for more wildlife.',
    bestTimeEs: 'Temporada seca mayo-octubre para viaje más fácil. Temporada húmeda diciembre-marzo para más vida silvestre.',
    tips: [
      'Book eco-lodge packages in advance',
      'Minimum 3 nights recommended',
      ...
      'Kids love jungle activities'
    ],
    tipsEs: [
      'Reserva paquetes de eco-lodge con anticipación',
      'Mínimo 3 noches recomendadas',
      'Trae repelente de insectos',
      'Impermeabiliza todo',
      'Botas de caucho proporcionadas por lodges',
      'Mañanas tempranas mejores para vida silvestre',
      'Binoculares esenciales',
      'Niños aman actividades de selva'
    ],
    nearbyAttractions: ['Puerto Maldonado', 'Lake Sandoval', 'Monkey Island', 'Bahuaja-Sonene National Park'],
    relatedSites: ['pacaya-samiria-reserve', 'manu-biosphere-reserve'],
    gettingThere: 'Fly to Puerto Maldonado from Lima (1.5 hours) or Cusco (30 minutes). Lodges arrange river boat transfers.',
    gettingThereEs: 'Vuela a Puerto Maldonado desde Lima (1.5 horas) o Cusco (30 minutos). Lodges organizan transferencias en bote.',
    facilities: [
      'Multiple eco-lodges',
      'Research stations',
      'Canopy towers and walkways',
    ...
    facilitiesEs: [
      'Múltiples eco-lodges',
      'Estaciones de investigación',
      'Torres y pasarelas de dosel',
      'Transporte en bote',
      'Guías naturalistas entrenados',
      'Alojamientos con servicio completo'
    ]
  },
  {
    slug: 'karajia-sarcophagi',
    ...
    regionEs: 'Región Amazonas',
    altitude: 2700,
    description: 'The Karajía Sarcophagi are extraordinary 2-meter tall clay funerary figures standing sentinel on an inaccessible limestone cliff ledge 200 meters above the valley floor. Created by the Chachapoya civilization over 500 years ago, these haunting human-shaped coffins with oversized heads contained the mummified remains of important leaders and remain one of Peru most impressive and least-visited archaeological marvels.',
    descriptionEs: 'Los Sarcófagos de Karajía son extraordinarias figuras funerarias de arcilla de 2 metros de alto que se yerguen como centinelas en una repisa de acantilado de piedra caliza inaccesible 200 metros sobre el piso del valle. Creados por la civilización Chachapoya hace más de 500 años, estos inquietantes ataúdes con forma humana y cabezas sobredimensionadas contenían los restos momificados de líderes importantes y permanecen como una de las maravillas arqueológicas más impresionantes y menos visitadas de Perú.',
    history: 'Constructed by the Chachapoya culture between 1300-1400 CE, these sarcophagi were designed to house the mummified remains of important individuals - likely warriors or leaders based on the trophies found inside. The towering figures were built in their current location on the cliff face, with materials hauled up using rope systems. Each sarcophagus was constructed around the mummy, then decorated with a face and features. Originally there were eight figures; two were destroyed by an earthquake in 1928.',
    historyEs: 'Construidos por la cultura Chachapoya entre 1300-1400 EC, estos sarcófagos fueron diseñados para albergar los restos momificados de individuos importantes - probablemente guerreros o líderes basándose en los trofeos encontrados dentro. Las imponentes figuras fueron construidas en su ubicación actual en la cara del acantilado, con materiales subidos usando sistemas de cuerdas. Cada sarcófago fue construido alrededor de la momia, luego decorado con un rostro y características. Originalmente había ocho figuras; dos fueron destruidas por un terremoto en 1928.',
    highlights: [
      'Six 2-meter tall sarcophagi',
      'Dramatic cliff-side location',
      'Cloud forest hiking trail',
      'Original painted decorations',
      'Chachapoya cultural history',
      'Traditional village of Cruzpata',
      'Scenic mountain valley',
      'Uncrowded archaeological site'
    ],
    highlightsEs: [
      'Seis sarcófagos de 2 metros de alto',
      'Dramática ubicación en acantilado',
      'Sendero de caminata en bosque nuboso',
      'Decoraciones pintadas originales',
      'Historia cultural Chachapoya',
      'Pueblo tradicional de Cruzpata',
      'Valle de montaña escénico',
      'Sitio arqueológico sin multitudes'
    ],
    familyRating: 3,
    minAge: 8,
    duration: 'Half day from Chachapoyas',
    durationEs: 'Medio día desde Chachapoyas',
    difficulty: 'moderate',
    entranceFee: 'S/5 adults, S/2 students. Local guides S/20-30.',
    entranceFeeEs: 'S/5 adultos, S/2 estudiantes. Guías locales S/20-30.',
    bestTime: 'Dry season May-September. Morning for best lighting.',
    bestTimeEs: 'Temporada seca mayo-septiembre. Mañana para mejor iluminación.',
    tips: [
      'Hire local guide in Cruzpata village',
      'Bring binoculars for details',
      '45-minute hike through cloud forest',
      'Good hiking shoes essential',
      'Combine with Revash in full day',
      'Morning light best for photos',
      'Support local community guides',
      'Respect sacred site'
    ],
    tipsEs: [
      'Contrata guía local en pueblo Cruzpata',
      'Trae binoculares para detalles',
      'Caminata de 45 minutos por bosque nuboso',
      'Buenos zapatos de caminata esenciales',
      'Combina con Revash en día completo',
      'Luz de mañana mejor para fotos',
      'Apoya guías de comunidad local',
      'Respeta sitio sagrado'
    ],
    nearbyAttractions: ['Revash mausoleums', 'Kuelap', 'Gocta waterfall', 'Chachapoyas town'],
    relatedSites: ['revash-mausoleums', 'kuelap-fortress', 'gocta-waterfall'],
    gettingThere: 'From Chachapoyas: 1.5-hour drive (48 km) to Cruzpata village, then 45-minute hike to viewpoint.',
    gettingThereEs: 'Desde Chachapoyas: 1.5 horas en auto (48 km) a pueblo Cruzpata, luego 45 minutos de caminata a mirador.',
    facilities: [
      'Viewpoint platform',
      'Community guides in Cruzpata',
      'Basic village facilities',
      'Parking area',
      'Trail signage',
    ...
    facilitiesEs: [
      'Plataforma de mirador',
      'Guías comunitarios en Cruzpata',
      'Instalaciones básicas de pueblo',
      'Área de estacionamiento',
      'Señalización de sendero',
      'Artesanías locales en venta'
    ]
  }
];
